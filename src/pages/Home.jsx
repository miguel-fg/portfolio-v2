  ...
  return (
    <>
      ...
      <div className="flex flex-col w-9/12 lg:flex-row gap-20">
        <Link
          to="/portfolio"
          className="bg-sea-green border-4 border-sea-green text-center px-5 md:px-10 py-2.5 rounded-xl drop-shadow-md text-h3 text-nowrap uppercase font-LS text-alabaster mt-0 lg:mt-16 active:bg-oxford-blue active:border-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4 hover:bg-primary-600 hover:border-primary-600"
        >
          See my work
        </Link>
        <Link
          to="/contact"
          className="bg-alabaster border-4 border-primary-600 text-center px-5 md:px-10 py-2.5 rounded-xl drop-shadow-md text-h3 text-nowrap uppercase font-LS text-primary-700 mt-0 lg:mt-16 active:bg-oxford-blue active:text-alabaster active:border-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4 focus:border-alabaster hover:bg-grayscale-200"
        >
          Get in touch
        </Link>
      </div>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-6">
        <div className="lg:col-span-1">
          ...
          <Link
            to="/about"
            className="bg-sea-green text-center px-20 py-5 rounded-xl drop-shadow-md text-h3 uppercase font-LS text-alabaster active:bg-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4 hover:bg-primary-600"
          >
            About me
          </Link>
        </div>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-6">
        ...
        <div className="lg:col-span-1 lg:ml-6">
          ...
          <p className="text-body font-MT text-oxford-blue mb-8 lg:mb-10">
            I use the best tools and frameworks to create robust, responsive,
            and user-friendly websites and applications. Each project is made
            with trusted technology and functional design, ensuring an engaging
            experience for users.
          </p>
          <Link
            to="/portfolio"
            className="bg-sea-green text-center text-nowrap px-5 md:px-10 py-5 rounded-xl drop-shadow-md text-h3 uppercase font-LS text-alabaster active:bg-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4 hover:bg-primary-600"
          >
            View my projects
          </Link>
        </div>
