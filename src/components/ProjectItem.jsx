    ...
    return (
        <div className="col-span-12 flex flex-row">
            ...
            <div className="ml-10 flex flex-col justify-between">
                ...
                <Link
                    to="/oops"
                    className="bg-sea-green w-fit text-h3 font-LS uppercase text-alabaster px-10 py-2.5 rounded-xl drop-shadow-md active:bg-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4"
                >
                    Learn More
                </Link>
            </div>
