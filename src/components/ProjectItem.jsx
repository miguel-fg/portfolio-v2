  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="md:ml-5 lg:ml-10 flex flex-col justify-between">
        ...
        <p className="mt-4 text-body font-MT text-oxford-blue">{description}</p>
        <Link
          to={`/project/${url_name}`}
          className="mt-4 mb-10 md:mb-2 bg-sea-green w-fit text-h3 font-LS uppercase text-alabaster px-10 py-2.5 rounded-xl drop-shadow-md active:bg-oxford-blue focus:outline-none focus:ring-oxford-blue focus:ring-4 hover:bg-primary-600"
        >
          Learn More
        </Link>
      </div>
