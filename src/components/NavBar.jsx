          ...
          >
            <ul className="block w-full lg:w-fit-content h-fit-content flex flex-col lg:flex-row lg:self-center lg:items-center">
              ...
              <li className="flex justify-center">
                <Link
                  to="/contact"
                  className="text-h3 text-center mt-6 lg:mt-0 font-LS uppercase text-alabaster bg-sea-green inline-block w-11/12 lg:w-auto lg:px-10 py-2.5 rounded-xl drop-shadow-md active:bg-oxford-blue active:text-alabaster hover:bg-primary-600"
                >
                  Contact
                </Link>
              </li>
