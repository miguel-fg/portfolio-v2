...
const TechStackIcon = (props) => {
  ...
  switch (iconName) {
    ...
    case "Typescript":
      return (
        <SiTypescript
          title="Typescript brand icon"
          className={`${className}`}
        />
      );
    case "Vue":
      return (
        <SiVuedotjs title="Vue.js brand icon" className={`${className}`} />
      );
    case "Express":
      return (
        <SiExpress title="Express brand icon" className={`${className}`} />
      );
    case "PostgreSQL":
      return (
        <SiPostgresql
          title="PostgreSQL brand icon"
          className={`${className}`}
        />
      );
    case "MongoDB":
      return (
        <SiMongodb title="MongoDB brand icon" className={`${className}`} />
      );
  }
};
